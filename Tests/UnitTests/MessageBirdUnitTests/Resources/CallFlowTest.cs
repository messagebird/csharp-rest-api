    ...
    public class CallFlowTest
    {
        ...
        public void Create()
        {
            var restClient = MockRestClient
                ...
                .FromEndpoint("POST", "call-flows", CallFlowsResource.CallFlowsBaseUrl)
                .Get();
        ...
        public void Delete()
        {
            var restClient = MockRestClient
                ...
                .FromEndpoint("DELETE", "call-flows/foo-id", CallFlowsResource.CallFlowsBaseUrl)
                .Get();
        ...
        public void List()
        {
            var restClient = MockRestClient
                ...
                .FromEndpoint("GET", "call-flows?limit=20&offset=0", CallFlowsResource.CallFlowsBaseUrl)
                .Get();
        ...
        public void Update()
        {
            var restClient = MockRestClient
                ...
                .FromEndpoint("PUT", "call-flows/de3ed163-d5fc-45f4-b8c4-7eea7458c635", CallFlowsResource.CallFlowsBaseUrl)
                .Get();
        ...
        public void View()
        {
            var restClient = MockRestClient
                ...
                .FromEndpoint("GET", "call-flows/de3ed163-d5fc-45f4-b8c4-7eea7458c635", CallFlowsResource.CallFlowsBaseUrl)
                .Get();
